// in frontend/src/components/Header.jsx (Full file replacement)

import React from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { useAuth } from '../hooks/useAuth';
import { useSocket } from '../context/SocketContext'; // New: Import useSocket

const Header = () => {
  const { user, logout } = useAuth();
  const { notifications } = useSocket(); // New: Get notifications
