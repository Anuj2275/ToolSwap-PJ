// in frontend/src/pages/LoginPage.jsx (full file replacement)
...
const LoginPage = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-20">
      {/* FIX: Use bg-opacity/dark:bg-opacity for true glassmorphism and better contrast */}
      <div className="bg-white/70 dark:bg-gray-800/80 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 p-10 rounded-2xl shadow-2xl">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            {/* FIX: Use explicit dark:text-white for labels */}
          ...
          <button 
            type="submit" 
            // FIX: Use highly visible color and explicit white text (color was the issue)
